...
>>>>>>> 21c0ad50087083401eb946f194daecbe379e9463
...
<<<<<<< HEAD
  request.get(url).then(async (body) => {
    ...
    var parse_body = new JSDOM(body.replace(/(\\r|\\n)/g,"")).window.document;
=======
  var opt = {
    url: url,
    method: 'GET'
...
//        break;
      ...
      try{
        ...
        console.log(JSON.parse(parse_body.querySelector("#meta-preload-data").attributes.content.value));
        var image_data = JSON.parse(parse_body.querySelector("#meta-preload-data").attributes.content.value).illust[parseInt(pixiv_image_id)];
      }catch{
